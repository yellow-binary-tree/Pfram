...
class TransformerBlock(nn.Module):
    ...
    def forward(self, x: torch.Tensor, output_hidden_states=False, attn_mask: Optional[torch.Tensor] = None):
...
class VisionTransformer(nn.Module):
    ...
    def forward(self, x: torch.Tensor, output_hidden_states=False):
        ...
        x, hidden_states = self.transformer(x, output_hidden_states)
    ...
    def encode(self, image_paths: List[str], output_hidden_states=False):
        images = []
        ...
        return self(images, output_hidden_states)
