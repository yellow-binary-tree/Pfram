...
def build_vision_tower(select_feature='patch'):
    vision_tower = 'openai/clip-vit-large-patch14-336'
    return CLIPVisionTower(vision_tower, select_feature=select_feature)
...
class CLIPVisionTower(nn.Module):
    ...
    def __init__(self, vision_tower, select_feature):
        super().__init__()
